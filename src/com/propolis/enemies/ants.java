...
public class ants extends BaseEnemy {
	...
	public ants(float x, float y, float mass, float size) throws SlickException {
		super(x, y, mass, size);
		// TODO Auto-generated constructor stub
		walking = new SpriteSheet("res/Ant walk.png", 14,21);
		...
		aliveSound = new Sound("res/alive_beetle.wav");
