...
/*
 * Ok  - so not really an enemy- but I'm going to use lots of this code
 */
public class BeeMessanger extends BaseEnemy {
	...
	public BeeMessanger(float x, float y, float mass, float size)
